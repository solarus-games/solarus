...
if(NOT XCODE)
  if(SOLARUS_CURRENT_OSX_VERSION_SHORT VERSION_EQUAL "10.6" AND SOLARUS_DEPLOYMENT VERSION_LESS "10.6")
    ...
    # Use conditions to avoid duplicate flags caused by set(... FORCE)
    if(NOT CMAKE_CXX_FLAGS MATCHES "-force_cpusubtype_ALL")
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -force_cpusubtype_ALL" CACHE STRING "Force all cpu subtypes, to avoid trouble with some old architectures")
    endif()
