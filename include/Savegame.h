...
class Savegame: public ExportableToLua {
  ...
  public:
     ...
     * Values before 63 are reserved by the engine.
     * Scripts only have a read-only access to them.
     * Values above 64 are available for the scripts in both reading and
     * writing.
     */
    enum StringIndex {
