...
class VideoManager {
  ...
  private:
    ...
    static const std::string normal_mode_name; /**< Non-shaded mode name. It will be forbidden for shaded ones. */
    static const std::string forced_mode_name; /**< Name of the forced mode, or empty string to allow all modes. */
