...
class LuaContext {
  ...
  private:
    ...
    static FunctionAvailableToScript
      ...
      entity_api_remove,
      entity_hero_api_freeze,
      entity_hero_api_unfreeze,
      entity_hero_api_set_map,
      entity_hero_api_set_visible,
      entity_hero_api_get_direction,
      entity_hero_api_set_direction,
      entity_hero_api_set_position,
      entity_hero_api_align_on_sensor,
      entity_hero_api_save_solid_ground,
      entity_hero_api_reset_solid_ground,
      entity_hero_api_walk,
      entity_hero_api_start_jumping,
      entity_hero_api_start_treasure,
      entity_hero_api_start_victory_sequence,
      entity_hero_api_start_boomerang,
      entity_hero_api_start_bow,
      entity_hero_api_start_hookshot,
      entity_hero_api_start_running,
      entity_hero_api_start_hurt,
      entity_npc_api_start_movement,
      entity_npc_api_stop_movement,
      entity_npc_api_get_sprite,
      entity_npc_api_set_position,
      entity_chest_api_is_open,
      entity_chest_api_set_open,
      entity_block_api_reset,
      entity_block_api_set_position,
      entity_switch_api_is_activated,
      entity_switch_api_set_activated,
      entity_switch_api_set_locked,
      entity_door_api_open,
      entity_door_api_close,
      entity_door_api_is_open,
      entity_door_api_set_open,
      entity_enemy_api_get_life,
      entity_enemy_api_set_life,
      entity_enemy_api_add_life,
      entity_enemy_api_remove_life,
      entity_enemy_api_get_damage,
      entity_enemy_api_set_damage,
      entity_enemy_api_get_magic_damage,
      entity_enemy_api_set_magic_damage,
      entity_enemy_api_is_pushed_back_when_hurt,
      entity_enemy_api_set_pushed_back_when_hurt,
      entity_enemy_api_get_push_hero_on_sword,
      entity_enemy_api_set_push_hero_on_sword,
      entity_enemy_api_get_can_hurt_hero_running,
      entity_enemy_api_set_can_hurt_hero_running,
      entity_enemy_api_get_hurt_style,
      entity_enemy_api_set_hurt_style,
      entity_enemy_api_get_can_attack,
      entity_enemy_api_set_can_attack,
      entity_enemy_api_get_minimum_shield_needed,
      entity_enemy_api_set_minimum_shield_needed,
      entity_enemy_api_set_attack_consequence,
      entity_enemy_api_set_attack_consequence_sprite,
      entity_enemy_api_set_default_attack_consequences,
      entity_enemy_api_set_default_attack_consequences_sprite,
      entity_enemy_api_set_invincible,
      entity_enemy_api_set_invincible_sprite,
      entity_enemy_api_set_layer_independent_collisions,
      entity_enemy_api_set_treasure,
      entity_enemy_api_set_no_treasure,
      entity_enemy_api_set_random_treasure,
      entity_enemy_api_get_obstacle_behavior,
      entity_enemy_api_set_obstacle_behavior,
      entity_enemy_api_get_optimization_distance,
      entity_enemy_api_set_optimization_distance,
      entity_enemy_api_set_size,
      entity_enemy_api_set_origin,
      entity_enemy_api_set_position,
      entity_enemy_api_get_distance_to_hero,
      entity_enemy_api_get_angle_to_hero,
      entity_enemy_api_test_obstacles,
      entity_enemy_api_snap_to_grid,
      entity_enemy_api_get_movement,
      entity_enemy_api_start_movement,
      entity_enemy_api_stop_movement,
      entity_enemy_api_restart,
      entity_enemy_api_hurt,
      entity_enemy_api_create_sprite,
      entity_enemy_api_remove_sprite,
      entity_enemy_api_get_sprite,
      entity_enemy_api_create_son,
      entity_enemy_api_get_father,
      entity_enemy_api_send_message,
