...
destination{
  ...
  x = 368,
  y = 61,
  name = "from_cave_under_waterfall_c",
  direction = 3,
}
...
destination{
  ...
  x = 56,
  y = 365,
  name = "from_cave_under_waterfall_s",
  direction = 3,
}
