...
dialog{
  id = "_item_description.apple_pie_counter.1",
  icon = 22,
  skip = "all",
  text = [[
Cette tarte aux
...
dialog{
  id = "_item_description.roc_magma_counter.1",
  icon = 44,
  skip = "all",
  text = [[
Roc magma des mines
...
dialog{
  id = "_item_description.sac_riz_counter.1",
  icon = 45,
  skip = "all",
  text = [[
Sacs de riz basmati
...
dialog{
  id = "_item_description.sac_olive_counter.1",
  icon = 46,
  skip = "all",
  text = [[
Sacs d'olives, les
...
dialog{
  id = "dungeon_1.after_map_treasure",
  text = [[
Et pour pleurer
devant la taille du
donjon !
...
-- Zelda
dialog{
  id = "_treasure.zelda.1",
  text = [[
Tu as retrouvé la
Princesse Zelda !
Apparemment, tu l'avais
juste enfermée dans ton
coffre !
]]
}
-----------------------
...
dialog{
  id = "caverne_fragments.sign",
  text = [[
Seul le vrai héros
obtiendra le trésor.$0$0
Ou pas.
]]
}
-----------------------
...
dialog{
  id = "maison_boulet.boulet",
  text = [[
XD lol ! Zelda xd c
tro lol xd mdr gro b
isous t nul lol mdr!
]]
}
-----------------------
...
dialog{
  id = "crazy_house.mario_message_1",
  skip = "current",
  text = [[
It's me, Mario !
]]
...
dialog{
  id = "crazy_house.directionsAccueil",
  skip = "current",
  text = [[
      - Accueil -
...
dialog{
  id = "crazy_house.directions_1F_se",
  skip = "current",
  text = [[
Escalier :
guichets 22, 12
...
dialog{
  id = "crazy_house.directions_1F_sw",
  skip = "current",
  text = [[
Téléporteur vers l'aile
droite
]]
}
-----------------------
...
dialog{
  id = "crazy_house.directions_2F_no",
  skip = "current",
  text = [[
Escalier :
guichets 49, 47, 45
...
dialog{
  id = "crazy_house.directions_2F_ne",
  skip = "current",
  text = [[
Téléporteur vers les
guichets 11, 21 et
vers l'accueil
]]
}
...
dialog{
  id = "crazy_house.directions_2F_e",
  skip = "current",
  text = [[
Gauche : guichet 22
Escaliers : accueil,
...
dialog{
  id = "crazy_house.directions_3F_3",
  skip = "current",
  text = [[
Autre écriteau placé
exprès ici pour vous
gêner.
]]
}
-----------------------
...
dialog{
  id = "crazy_house.directions_3FC",
  skip = "current",
  text = [[
Escaliers vers les
guichets 84, 49, 47, 45
]]
}
-----------------------

dialog{
  id = "crazy_house.giga_bouton_trop_leger",
  skip = "current",
  text = [[
Tu es beaucoup trop
léger pour activer le
giga bouton d'extra
collision à charge
...
dialog{
  id = "crazy_house.accueil_ech_eq_1",
  text = [[
Prenez l'escalier
derrière moi pour le
guichet 21.
]]
}
-----------------------
...
dialog{
  id = "crazy_house.accueil_ech_eq_4",
  text = [[
Le guichet 33 ? Il est
au deuxième étage,
dans l'aile gauche.
]]
}
...
dialog{
  id = "crazy_house.accueil_ech_eq_8",
  text = [[
Le guichet 22 ? Il est
...
dialog{
  id = "crazy_house.accueil_epi_eo_8-10",
  text = [[
Un vieillard ? Je ne
sais pas monsieur,
désolé.
...
dialog{
  id = "crazy_house.accueil_bal_eq_2",
  text = [[
Le guichet 82 est au
premier étage aile
droite.
]]
}
...
dialog{
  id = "crazy_house.accueil_bal_eq_4",
  text = [[
Le guichet 32 est au
deuxième étage aile
droite.
]]
}
...
dialog{
  id = "crazy_house.accueil_bal_eq_7",
  text = [[
Des sacs de riz ?
Essayez le guichet 36
au deuxième étage.
]]
}
-----------------------
...
dialog{
  id = "crazy_house.accueil_fini",
  text = [[
Vous avez retrouvé
vos gants monsieur ?
Parfait.
Le Bureau des Objets
Trouvés a été heureux
de vous accueillir
et espère vous revoir
prochainement.
Bonne continuation !
]]
}
...
-- 
dialog{
  id = "crazy_house.guichet_12_sign",
  skip = "current",
  text = [[
A droite : guichet 12
A gauche : accueil
...
dialog{
  id = "crazy_house.guichet_12A_ech_ne_5",
  skip = "current",
  text = [[
...
dialog{
  id = "crazy_house.guichet_12B_ech_eq_7_ok",
  skip = "current",
  text = [[
Merci beaucoup, voici
un parfum Cacaco
Charnel.
]]
}
...
dialog{
  id = "crazy_house.guichet_12B_ech_eq_7_no",
  skip = "current",
  text = [[
Relou ? C'est quoi
relou ?
...
dialog{
  id = "crazy_house.guichet_21_ech_ne_1",
  skip = "current",
  text = [[
...
dialog{
  id = "crazy_house.guichet_22_rm_ok",
  skip = "current",
  text = [[
Merci beaucoup, voici
votre balai.
...
dialog{
  id = "crazy_house.guichet_22_sr_un",
  skip = "current",
  text = [[
Désolé, il vous faut
un sac de riz.
...
dialog{
  id = "crazy_house.guichet_22_sr_ok",
  skip = "current",
  text = [[
Et voilà la superbe
tapisserie !
...
dialog{
  id = "crazy_house.guichet_32_ech_ne_6_un",
  skip = "current",
  text = [[
Désolé mais vous n'avez
pas de hache pour
honorer cet échange.
]]
}
...
dialog{
  id = "crazy_house.guichet_32_ech_ne_6_no",
  text = [[
Non ? Quel dommage,
vous manquez quelque
chose.
]]
}
-----------------------
...
dialog{
  id = "crazy_house.guichet_41_ech_ne_3",
  skip = "current",
  text = [[
Désolé, je suis en
pause là, et j'en ai
...
dialog{
  id = "crazy_house.guichet_45_ech_un",
  skip = "current",
  text = [[
Quel dommage, vous
n'avez pas de
...
dialog{
  id = "crazy_house.guichet_45_ech_ok",
  skip = "current",
  text = [[
Parfait, voici votre
sac d'olives.
...
dialog{
  id = "crazy_house.guichet_47_ech_eq_3",
  skip = "current",
  text = [[
Bonjour, vous cherchez
le guichet 41 ?
Ah non ici c'est le 47.
]]
}
-----------------------
...
dialog{
  id = "crazy_house.guichet_82_un",
  skip = "current",
  text = [[
Désolé, il te faut au
moins un sac d'olives
pour ce roc magma.
]]
}
-----------------------
...
dialog{
  id = "crazy_house.vieillard_ronfl",
  text = [[
Ronfl... ZZZ...
]]
}
...
dialog{
  id = "crazy_house.apothicaire_non",
  skip = "current",
  text = [[
...
dialog{
  id = "crazy_house.apothicaire_oui",
  skip = "current",
  text = [[
Huhu, vous avez fait
une bonne affaire.
...
dialog{
  id = "outside_fields_NE_girly_sign",
  text = [[
Nous aussi nous
respectons la parité
féminin / masculin.
]]
}
-----------------------
...
dialog{
  id = "outside_fields_SO.guard_nok",
  text = [[
Pas de resquilleur !
Va faire la queue comme
tout le monde.
]]
}
-----------------------
...
dialog{
  id = "outside_fields_SO.forest_monkey_end",
  text = [[
Ook ! Ook ! Ook !
]]
}
...
dialog{
  id = "outside_fields_SE.temple_door_closed",
  text = [[
C'est fermé à clé...
]]
}
...
dialog{
  id = "outside_fields_SE.yoda_quote_1",
  skip = "all",
  text = [[
Non, n'essaie pas.
Saute, ou ne saute pas.
...
dialog{
  id = "outside_fields_SE.yoda_quote_2",
  skip = "all",
  text = [[
Link, fais appel à
la Forcetri.
...
dialog{
  id = "outside_fields_SE.yoda_quote_3",
  skip = "all",
  text = [[
...
dialog{
  id = "outside_fields_SE.yoda_quote_4",
  skip = "all",
  text = [[
Quand 900 ans comme moi
tu auras, moins en
forme tu seras.
]]
}
...
dialog{
  id = "outside_fields_SE.yoda_quote_5",
  skip = "all",
  text = [[
...
dialog{
  id = "outside_fields_SE.yoda_quote_6",
  skip = "all",
  text = [[
Toujours par deux ils
vont. Ni plus, ni
moins.
]]
}
...
dialog{
  id = "outside_fields_SE.yoda_quote_7",
  skip = "all",
  text = [[
Te conduire jusqu'à
Zelda je puis.
...
dialog{
  id = "outside_fields_SE.yoda_quote_8",
  skip = "all",
  text = [[
Prêt tu crois être.
Comment peux-tu
...
dialog{
  id = "outside_fields_SE.yoda_quote_9",
  skip = "all",
  text = [[
Que la Forcetri soit
avec toi.
]]
}
-----------------------
...
dialog{
  id = "outside_fields_SE.yoda_quote_10",
  skip = "all",
  text = [[
De bonnes relations
avec les Cookies,
...
dialog{
  id = "outside_fields_SE.yoda_quote_11",
  skip = "all",
  text = [[
...
dialog{
  id = "outside_fields_SE.yoda_give_sword",
  text = [[
Robuste je suis grâce à
la Forcetri, mais pas à
ce point là.
Le crépuscule m’envahit
et bientôt, la nuit va
tomber.
Terminée, ta formation
est.
Ainsi vont les choses.
Ainsi va la Forcetri.
]]
}
-----------------------

dialog{
  id = "outside_fields_SE.yoda_finished",
  skip = "all",
  text = [[
A travers la Forcetri,
d'autres choses tu
verras, d'autres
lieux : l'avenir, le
passé, de vieux amis
...
dialog{
  id = "outside_fields_SE.west_sign",
  text = [[
Sud-est :
...
dialog{
  id = "outside_fields_NO_goa",
  text = [[
Trouvez le secret du 
lol doré
]]
}
-----------------------
...
dialog{
  id = "outside_fields_NO.lawn_master",
  text = [[
Je t'offre 100 rubis
si tu tonds toute la
pelouse.
]]
}
-----------------------
...
dialog{
  id = "outside_fields_NO.castle_guard",
  text = [[
Excuse-nous, on a perdu
la clé. On ne peut pas
t'ouvrir.
]]
}
-----------------------
...
dialog{
  id = "outside_fields_NE.cursed_cave_sign",
  text = [[
  - Caverne maudite -
   Entrée condamnée
  pour votre sécurité
...
dialog{
  id = "outside_fields_NE.tipiton_sign",
  text = [[
Sommet du Mont Tipiton
Altitude :
pas super haut, en fait
]]
}
-----------------------

dialog{
  id = "outside_fields_NE.indic",
  text = [[
Ouest : Château
Nord : Désert Bakasable
Mont Tipiton
Sud : Bar
...
dialog{
  id = "outside_fields_NE.south_sign",
  text = [[
Sud :
Marais de la Forcetri
Ouest :
...
dialog{
  id = "freaking_cave_indic2",
  text = [[
Désolé, on avait plus 
assez de rubis pour
acheter un coffre neuf.
]]
}
-----------------------

dialog{
  id = "freaking_cave_teleporter",
  text = [[
Une force mysterieuse 
vous empêche d'emprunter
le téléporteur.
]]
}
-----------------------
...
dialog{
  id = "shop.heart_container",
  next = "_unknown",
  text = [[
Un Réceptacle de Coeur.
Plutôt banal.
]]
}
-----------------------
...
dialog{
  id = "shop.huge_rupee_bag",
  next = "_unknown",
  text = [[
Un Sac de Rubis Géant.
...
dialog{
  ...
  skip = "all",
  text = [[
Ce type m'insupporte !
Ca fait deux heures que
ce fan de sorcellerie
me saoûle avec ses
histoires. En plus, il
est hyper susceptible !
]]
}
-----------------------

dialog{
  id = "shop.last_night_guy",
  text = [[
Hé, salut gros !
Ca farte depuis
hier soir ?
...
dialog{
  id = "desert.east_house.first_time",
  text = [[
Au nord d'ici se trouve
la Caverne Maudite.
Personne n'en est
jamais revenu.
N'y va surtout pas !
...
dialog{
  id = "desert.east_house.back_from_dead",
  text = [[
Quoi ? Tu es allé à la
Caverne Maudite ?
Les jeunes de nos jours
sont vraiment des
inconscients !
Nous aurions dû
insister plus sur les
dangers de ce lieu.
Je t'avais pourtant mis
en garde : ce n'est pas
là que tu dois aller.
La suite du jeu, c'est
pas du tout ça !
Si tu veux voir Ganon,
rien de plus simple,
prends juste la clé
dans ma chambre à côté.
Tu pouvais le dire tout
de suite au lieu de
...
dialog{
  id = "desert.east_house.bone_key",
  text = [[
Cette clé est la clé
du repère de Ganon.
]]
}
-----------------------
...
dialog{
  id = "desert.west_house",
  text = [[
Plusieurs aventuriers
ont osé pénétrer dans
la Caverne Maudite.
On n'a plus jamais
entendu parler d'eux...
De nos jours, l'accès
est condamné pour
protéger les curieux.
]]
}
-----------------------

dialog{
  id = "desert.small_house",
  text = [[
Si tu cherches à te
suicider, un bon moyen
d'y parvenir est de te
rendre à la Caverne
Maudite au nord.
La douleur et le
résultat sont garantis.
]]
}
-----------------------

dialog{
  id = "link_cave.angry_zelda",
  text = [[
Toi !!! Tu m'as
enfermée ici et tu
m'as oubliée !
Tu m'as laissée moisir
dans ta cave !
Toi et tes potes, vous
n'êtes que des
alcooliques !
Je ne trouve pas ça
drôle du tout !!!
Cette fois-ci, j'en ai
...
dialog{
  id = "the_end.credits",
  text = [[
$1Ce jeu parodique a été
réalisé en sept
semaines par l'équipe
de Zelda : Mystery of
Solarus DX à l'occasion
du 1er avril 2011,
...
JB
Nintendo
Et bravo à vous d'être
arrivé jusqu'à la fin !
...
dialog{
  id = "link_house.intro",
  text = [[
$1D'anciennes légendes
racontent qu'il y a
bien longtemps,
existait une magnifique
contrée du nom d'Hyrule.$0$0
Ce royaume prospérait
sous la bénédiction de
trois déesses.
Après la création du
monde, les trois
déesses laissèrent un
symbole de leur passage
sous la forme de la
Triforce.$0$0
Sept Sages scellèrent
la Triforce dans la
Terre d'Or.
Ce texte s'écrit très
lentement et ne peut
pas être passé.$0$0
Il est également
ponctué de plusieurs
arrêts ennuyeux.$0$0
Tu as très envie de
commencer à jouer, mais
ce texte inintéressant
défile sur un ton
solennel et dans une
ambiance de légende,
donc tu es prié de
l'accepter.
$3Bon, ok, j'abrège.
C'est le matin. Tu te
réveilles à côté de ton
lit et tu es amnésique.
Tu ne te souviens plus
d'hier et tu n'as plus
ton équipement !
J'oubliais : la
princesse Zelda a
disparu.
...
dialog{
  id = "water_house.give_bottle",
  text = [[
Tu n'as pas l'air
d'aimer beaucoup l'eau.
Moi, j'adore ça.
Alors tiens, voici une
bouteille d'eau, ça ne
te fera pas de mal !
]]
}
-----------------------
...
dialog{
  id = "dungeon_1.welcome",
  text = [[
        Niveau 2       
 Temple des Stupidités 
]]
}
-----------------------

dialog{
  id = "dungeon_1.lizarmen_sign",
  text = [[
En hommage au pire
mini-boss de l'histoire
du jeu amateur.
]]
}
-----------------------
...
dialog{
  id = "dungeon_1.big_code_ok",
  text = [[
Début du code détecté.
Accès autorisé.
Mais si tu veux mon
avis, si tu entres le
reste du code, il ne se
...
dialog{
  id = "dungeon_1.big_code_completed",
  text = [[
Je te l'avais dit !
]]
}
...
dialog{
  id = "dungeon_1.danger_north_sign",
  text = [[
Nord : danger
Ne pas entrer svp
]]
...
dialog{
  id = "dungeon_1.danger_south_sign",
  text = [[
Sud : danger
...
dialog{
  id = "dungeon_1.small_key_danger_east",
  text = [[
Par contre, ne va pas
à l'est, c'est sûrement
dangereux.
]]
}
-----------------------
...
dialog{
  id = "dungeon_1.stupid_run_sign",
  text = [[
Sur votre droite : 
hommage à une épreuve
vraiment stupide.
]]
}
-----------------------
...
dialog{
  id = "dungeon_1.2f_sw_water_removed",
  text = [[
Au loin... un bruit...
]]
}
...
dialog{
  ...
  text = [[
La princesse Zelda ?
Non, elle n'est pas du
tout ici.
C'est toi qui es parti
avec elle, on t'a tous
vu la raccompagner !
D'ailleurs, personne
ne s'attendait à ce
...
Ha ha ha ha ha !
Bref, elle n'est pas
ici. Tu as bien regardé
partout chez toi ?
Pense peut-être à jeter
un coup d'oeil dans ta
maison, à l'occasion.
En attendant, je ne
suis pas contre un
petit combat à mort.
