...
/*
 * Saved data:
 * - Reserved data (for the game engine):
 *   0: starting map id
...
Uint32 Savegame::get_int(int index) {
  return saved_data.int_values[index];
}
...
void Savegame::set_int(int index, Uint32 value) {
  saved_data.int_values[index] = value;
}

/**
 * Returns a boolean value saved.
 * @param index index of the value to get, between 0 and 65535
 * @return the boolean value saved at this index
 */
bool Savegame::get_bool(int index) {

  Uint32 word = saved_data.bool_values[index / 32];
 ...
 * @param index index of the value to set, between 0 and 65535
...
void Savegame::set_bool(int index, bool value) {
  ...
  saved_data.bool_values[index / 32] |= mask;
