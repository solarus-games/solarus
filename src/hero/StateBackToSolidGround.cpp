 ...
 */
Hero::StateBackToSolidGround::StateBackToSolidGround(Hero *hero, bool use_memorized_xy):
  State(hero) {
 ...
 */
void Hero::StateBackToSolidGround::start(State *previous_state) {
 ...
 */
void Hero::StateBackToSolidGround::stop(State *next_state) {
 ...
 */
void Hero::StateBackToSolidGround::update(void) {
 ...
 */
bool Hero::StateBackToSolidGround::can_start_gameover_sequence(void) {
  return false;
}
 ...
 */
bool Hero::StateBackToSolidGround::is_hero_visible(void) {
  return false;
}
 ...
 */
bool Hero::StateBackToSolidGround::can_avoid_deep_water(void) {
  return true;
}
 ...
 */
bool Hero::StateBackToSolidGround::can_avoid_hole(void) {
  return true;
}
 ...
 */
bool Hero::StateBackToSolidGround::is_touching_ground(void) {
  return false;
}
 ...
 */
bool Hero::StateBackToSolidGround::are_collisions_ignored(void) {
  return true;
}
 ...
 */
bool Hero::StateBackToSolidGround::can_avoid_conveyor_belt(void) {
  return true;
}
 ...
 */
bool Hero::StateBackToSolidGround::can_avoid_sensor(void) {
  return true;
}
 ...
 */
bool Hero::StateBackToSolidGround::can_avoid_explosion(void) {
  return true;
}
