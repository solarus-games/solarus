 ...
 */
Hero::StateConveyorBelt::StateConveyorBelt(Hero *hero, ConveyorBelt *conveyor_belt):
 ...
 */
void Hero::StateConveyorBelt::start(State *previous_state) {
  ...
  snapping = true;
  hero->set_movement(new TargetMovement(conveyor_belt, hero->get_walking_speed()));
}
 ...
 */
void Hero::StateConveyorBelt::stop(State *next_state) {
 ...
 */
void Hero::StateConveyorBelt::update(void) {
 ...
 */
bool Hero::StateConveyorBelt::can_avoid_teletransporter(void) {
 ...
 */
bool Hero::StateConveyorBelt::can_avoid_conveyor_belt(void) {
  return true;
}
