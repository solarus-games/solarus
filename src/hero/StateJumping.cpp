 ...
 */
void Hero::StateJumping::start(State *previous_state) {
 ...
 */
void Hero::StateJumping::stop(State *next_state) {
 ...
 */
void Hero::StateJumping::update(void) {
 ...
 */
bool Hero::StateJumping::can_start_gameover_sequence(void) {
  return false;
}
 ...
 */
int Hero::StateJumping::get_height_above_shadow(void) {
 ...
 */
bool Hero::StateJumping::is_touching_ground(void) {
  return false;
}
 ...
 */
bool Hero::StateJumping::can_avoid_deep_water(void) {
  return true;
}
 ...
 */
bool Hero::StateJumping::can_avoid_hole(void) {
  return true;
}
 ...
 */
bool Hero::StateJumping::can_avoid_teletransporter(void) {
  return true;
}
 ...
 */
bool Hero::StateJumping::can_avoid_conveyor_belt(void) {
  return true;
}
 ...
 */
bool Hero::StateJumping::is_sensor_obstacle(Sensor *sensor) {
 ...
 */
bool Hero::StateJumping::can_avoid_sensor(void) {
 ...
 */
bool Hero::StateJumping::can_be_hurt(void) {
  return false;
}
