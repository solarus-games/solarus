 ...
 */
void Hero::StatePulling::start(State *previous_state) {
 ...
 */
void Hero::StatePulling::stop(State *next_state) {
 ...
 */
void Hero::StatePulling::update(void) {
 ...
 */
bool Hero::StatePulling::is_grabbing_or_pulling(void) {
  return true;
}
 ...
 */
bool Hero::StatePulling::is_moving_grabbed_entity(void) {
 ...
 */
void Hero::StatePulling::notify_grabbed_entity_collision(void) {
 ...
 */
void Hero::StatePulling::stop_moving_pulled_entity(void) {
