 ...
 */
void Hero::StateStairs::set_suspended(bool suspended) {
 ...
 */
void Hero::StateStairs::start(State *previous_state) {
 ...
 */
void Hero::StateStairs::update(void) {
 ...
 */
bool Hero::StateStairs::is_teletransporter_delayed(void) {
  return true;
}
