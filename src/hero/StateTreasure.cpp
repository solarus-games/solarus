 ...
 */
void Hero::StateTreasure::start(State *previous_state) {
 ...
 */
void Hero::StateTreasure::stop(State *next_state) {
 ...
 */
void Hero::StateTreasure::update(void) {
 ...
 */
void Hero::StateTreasure::display_on_map(void) {
