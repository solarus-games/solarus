...
#if defined(SOLARUS_USE_APPLE_PREFIXED_WRITE_DIR)
...
#else
  std::string write_dir =  std::string(getUserApplicationSupportDirectory()) + (std::string) SOLARUS_WRITE_DIR + "/" + ini.get_string_value("write_dir");
#endif
