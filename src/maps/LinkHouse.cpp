...
void MapLinkHouse::load(void) {
  ...
  tile = tileset->get_tile(2);
  position_in_map.x = 32;
  position_in_map.y = 48;
  add_new_tile(tile, position_in_map, 16, 10);

  tile = tileset->get_tile(20);
  position_in_map.x = 0;
  position_in_map.y = 16;
  add_new_tile(tile, position_in_map);
  ...
  position_in_map.x = 8;
  position_in_map.y = 16;
  add_new_tile(tile, position_in_map, 24, 1);

  position_in_map.x = 216;
  position_in_map.y = 16;
  add_new_tile(tile, position_in_map, 12, 1);
  ...
  add_new_tile(tile, position_in_map, 1, 24);
  ...
  position_in_map.y = 24;
  add_new_tile(tile, position_in_map, 10, 1);

  tile = tileset->get_tile(41);
  position_in_map.x = 232;
  position_in_map.y = 24;
  add_new_tile(tile, position_in_map, 4, 1);

  tile = tileset->get_tile(43);
  position_in_map.x = 24;
  position_in_map.y = 200;
  add_new_tile(tile, position_in_map, 10, 1);
  ...
  add_new_tile(tile, position_in_map, 1, 10);
  ...
  position_in_map.x = 32;
  position_in_map.y = 40;
  add_new_tile(tile, position_in_map, 18, 1);

  tile = tileset->get_tile(13);
  position_in_map.x = 240;
  position_in_map.y = 40;
  add_new_tile(tile, position_in_map, 6, 1);
  ...
  position_in_map.x = 24;
  position_in_map.y = 48;
  add_new_tile(tile, position_in_map, 1, 18);
