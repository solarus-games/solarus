...
PauseMenu::PauseMenu(Game &game):
  ...
  set_current_submenu(savegame.get_integer("pause_last_submenu"));
}
...
void PauseMenu::draw(Surface& dst_surface) {
  ...
  int submenu_index = savegame.get_integer("pause_last_submenu");
...
void PauseMenu::set_current_submenu(int submenu_index) {
  ...
  savegame.set_integer("pause_last_submenu", submenu_index);
