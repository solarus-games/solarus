...
function map:on_opening_transition_finished()
  ...
  start_location_checker.check(game, "1", nil)
  ...
  sol.timer.start(20, function()
    ...
    sol.timer.start(20, function()
      start_location_checker.check(game, "1", "destination_3")
      hero:teleport("bugs/819_destination_starting_location_mode/2", nil, "immediate")
    end)
  end)
