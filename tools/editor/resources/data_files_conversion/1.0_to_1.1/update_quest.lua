...
local language_list_converter = require("language_list_converter_1_0")
...
local quest_properties_converter = require("quest_properties_converter_1_0")
...
local quest_db_converter = require("quest_db_converter_1_0")
local resources = quest_db_converter.convert(quest_path, languages)

-- Convert tilesets.
write_info("  Converting tilesets...")
local tileset_converter = require("tileset_converter_1_0")
