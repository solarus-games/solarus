The format of some data files has changed in Solarus 1.2,
...
To upgrade your quest data files from Solarus 1.1 to
Solarus 1.2, first
backup all your Solarus 1.1 quest data files. Then, type:
